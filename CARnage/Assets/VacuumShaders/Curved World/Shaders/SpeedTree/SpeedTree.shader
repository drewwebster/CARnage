...
Shader "VacuumShaders/Curved World/Nature/SpeedTree"
{
	Properties
	{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			#include "../cginc/CurvedWorld_SpeedTreeCommon.cginc"
		...
		Pass
		{
			...
			CGPROGRAM
				...
				v2f vert(SpeedTreeVB v)
				{
					...
					//V_CW_TransformPointAndNormal(IN.vertex, IN.normal, IN.tangent);
